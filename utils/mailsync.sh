...
# This is a modified version of Luke Smith's mailsync script from mutt-
# wizard. It syncs mail and refreshes a dwmblocks status script which 
# indicates if there are new mails.
...
syncandnotify() {
    ...
    new=$(find "$HOME/.local/share/mail/$acc/INBOX/new/" "$HOME/.local/share/mail/$acc/Inbox/new/" "$HOME/.local/share/mail/$acc/inbox/new/" -type f 2> /dev/null)
